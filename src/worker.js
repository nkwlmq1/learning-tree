...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/__oauth/callback" || url.pathname === "/oauth/callback" || url.pathname === "/login/callback" || url.pathname === "/login/return" || (url.pathname === "/" && url.searchParams.has("code") && url.searchParams.has("state"))) {
